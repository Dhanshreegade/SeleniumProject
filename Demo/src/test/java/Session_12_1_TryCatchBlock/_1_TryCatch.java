package Session_12_1_TryCatchBlock;
...
//		
		...
		catch (ArithmeticException e) 		// e is just a reference variable name for exception, can even write other variable name also
		{
